...
모바일 앱과 웹 백엔드 개발 모두 경험하였으며, 사용자 경험(UX)과 기술적 완성도를 동시에 고려하는 개발을 지향합니다.
...
- 구글·원스토어·화웨이 등 **8개 앱 마켓 운영 및 배포 관리**

### 📱 Micro Image QR (2021.07)
- Autofocus 및 Zoom 기능으로 **Micro QR 인식률 30% 개선**

### ☁️ Push 메시지 서비스 (2021.07~2021.11)
- Firebase Cloud Messaging(FCM) 기반 푸시 시스템 구축  
- **중국 내 FCM 미지원 대응:** Baidu Push API로 대체 개발  
- 사용자 알림 내역을 Room DB로 관리

### 🧩 플랫폼 리뉴얼 (2021.11~2022.02)
- 주요 UI 리뉴얼 및 전환 최적화  
- WebView + JavaScriptInterface 기반 양방향 통신 처리

---

# 💼 Project Experience

## ✅ 용하게써 (부모와 자녀가 함께 사용하는 용돈관리 플랫폼)
**기간:** 2025.07.28 ~ 2025.09.09 (44일)  
**팀원:** 5명  
**기술 스택:** Spring MVC, STS4, MyBatis, Oracle, JSP, HTML/CSS/JS, JWT, JavaMail, SweetAlert2  
**기획 의도:** 자녀가 주체적으로 소비·저축을 관리하고 부모가 실시간으로 확인할 수 있는 가정 맞춤형 금융 교육 플랫폼  

- **담당:** 기획 및 프론트 총괄 / DB 설계 / 용돈 이체·소비 내역·가족 초대 기능 개발  
- **성과:**  
  - 실계좌 구조를 모방한 계좌 등록 및 이체 기능 구현  
  - JWT 기반 가족 초대 기능 개발  
  - Git 브랜치 전략 도입 및 팀 협업 관리  
  - 스케줄러·트랜잭션·멀티스레드 활용  
- **GitHub:** [Yonghagesseo Repository](https://github.com/yooooooooj-ch/Yonghagesseo.git)
...
- **KG에듀원 핀테크 풀스택 개발자 양성과정 (2025.03 ~ 2025.09, 968h)**  
  Spring Boot, 금융결제원 API, 팀기반 핀테크 서비스 프로젝트 수행  

### 🏆 자격증
- 정보처리기사 (2017.05)  
- 전자계산기조직응용기사 (2018.11)  
- 리눅스마스터 2급 (2017.03)  
- 한국사능력검정시험 1급 (2021.06)  
- TOEIC 725 (2024.12)
...
- **7급 전산직 준비 (2022.02 ~ 2024.11):** SW공학, DB, 정보보호론 이론 심화  
- **수학 강사 (2018.11 ~ 2020.11)**  
- **봉사 134.5시간(37회):** 시각장애인 도서입력, 복지관 봉사, 헌혈 등  
