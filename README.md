...
### 🏫 5. 학교활동
#### ✅과 학술 동아리 **WMC** 활동 (2014.03~2017.08)
- **안드로이드 스터디 운영**
  - 여름방학 동안 진행된 동아리 내 ‘안드로이드 스터디’의 관리자역을 맡아, 비전공자 및 초보 개발자 중심의 학습 진행
  - 두 달간(7~8월)의 스터디를 완수하며 리더십·책임감·소통 능력을 강화함
  - 담당분야 및 역할:
    - 스터디 커리큘럼 및 학습 목표 수립 (기초 환경설정 → 간단한 앱 제작까지 단계별 구성)
    - 매 회차 강의 자료 및 실습 예제 직접 제작 및 진행
    - 미경험자 중심의 환경 구축, 코드 리뷰 및 실습 피드백 제공

- **서울특별시 앱 공모전 참여**
  - 동아리 내 3인 팀을 구성하여 서울특별시 주최 앱 개발 공모전에 참여. 팀장으로서 프로젝트 전체를 기획·관리하며 다양한 실력 수준의 팀원 간 협업 주도
  - 팀워크 기반의 프로젝트 완수를 통해 조직 내 조율 능력 및 실무형 협업 역량을 강화함
  - 담당분야 및 역할:
    - 프로젝트 기획 및 개발 일정 총괄
    - 팀원 역량별 역할 분담 및 작업 조율 (초보 개발자·숙련 개발자 간 간극 해소)
    - 기능 통합 및 테스트 수행, UI 구조 및 기능 개선 피드백 관리
